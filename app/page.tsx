...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] bg-red-100 items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          >
            <Image
              ...
              height={20}
            />
            Deploy now tere bina meri zindagi sfeurfyhewrfyug
          </a>
          <a
